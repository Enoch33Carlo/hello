...
💡 AI Summary:
- The engagement level was impressive given the event’s academic focus.
- The total amount collected (₹${totalCash}) indicates strong community support.
...
router.post("/generate", async (req, res) => {
  ...
  try {
    ...
    // 4️⃣ Generate AI-like insight (mock)
    ...
    // Header
    doc.fontSize(22).text("🎓 AI Campus Event Report", { align: "center" });
    doc.moveDown();
    ...
    doc.text(`Cash Collected: ₹${finance.cashCollected}`);
    doc.text(`Online Collected: ₹${finance.onlineCollected}`);
    doc.text(`Total Collected: ₹${totalCollected}`);
    doc.moveDown();

    // Registration
    doc.fontSize(14).text("👥 Registrations");
